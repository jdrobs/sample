...
import tradepackhelper.tradepack.Tradepack;

public class TradepackCalculator {
	
	//modifiers for the value of tradepacks
	//TODO: have these set as part of a settings file modified through a settings
	//file or gui
	...
	public double calculateValue(Place from, Place to) {
		...
		if (isWarmode()) multiplier += 0.20;
		if (isPerk1()) multiplier += 0.05;
		if (isPerk2()) multiplier += 0.10;
	...
	public static void main(String[] args) {
		...
		System.out.println(calc.calculateProfit(50, new SeabreezeRum(), Place.MARGROVE, Place.DEFIANCE));
		System.out.println(calc.calculateMinDemandForProfit(3000, new JuicersBox(), Place.MARGROVE, Place.DEFIANCE));
	}
